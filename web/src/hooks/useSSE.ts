...
function getSessionPatch(value: unknown): SessionPatch | null {
    ...
    if (value.codexCollaborationState === undefined || hasRecordShape(value.codexCollaborationState)) {
        if (Object.prototype.hasOwnProperty.call(value, 'codexCollaborationState')) {
            patch.codexCollaborationState = value.codexCollaborationState as Session['codexCollaborationState']
            hasKnownPatch = true
        }
    }
